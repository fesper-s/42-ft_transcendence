...
export default class GamePage extends HTMLElement {
  ...
  connectedCallback() {
    ...
    let match_id = null;
    if (game_header_query === "PG") game_header.textContent = "";
    if (game_type_query === "two") game_type.textContent = "";
    else if (game_type_query === "coop") game_type.textContent = "";
